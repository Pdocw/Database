...
# Form implementation generated from reading ui file 'score_add_ui.ui'
#
...
class Ui_Window_score_add(object):
    def setupUi(self, Window_score_add):
        Window_score_add.setObjectName("Window_score_add")
        Window_score_add.resize(1280, 720)
        Window_score_add.setMinimumSize(QtCore.QSize(1280, 720))
        Window_score_add.setMaximumSize(QtCore.QSize(1280, 720))
        self.label_title9 = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_title6 = QtWidgets.QLabel(Window_score_add)
        ...
        self.pushButton_stuno_inquiry = QtWidgets.QPushButton(Window_score_add)
        ...
        self.label_title7 = QtWidgets.QLabel(Window_score_add)
        ...
        self.lineEdit_stuno = QtWidgets.QLineEdit(Window_score_add)
        ...
        self.pushButton_add = QtWidgets.QPushButton(Window_score_add)
        self.pushButton_add.setGeometry(QtCore.QRect(590, 540, 200, 40))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(16)
        self.pushButton_add.setFont(font)
        self.pushButton_add.setObjectName("pushButton_add")
        self.label_title8 = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_title2 = QtWidgets.QLabel(Window_score_add)
        ...
        self.lineEdit_score = QtWidgets.QLineEdit(Window_score_add)
        ...
        self.label_title10 = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_title4 = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_title1 = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_title5 = QtWidgets.QLabel(Window_score_add)
        ...
        self.lineEdit_cno = QtWidgets.QLineEdit(Window_score_add)
        ...
        self.label_title3 = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_stuno_tip = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_stuname = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_credit = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_coursename = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_stusex = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_stuage = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_stuclass = QtWidgets.QLabel(Window_score_add)
        ...
        self.label_course_tip = QtWidgets.QLabel(Window_score_add)
        ...
        self.pushButton_course_inquiry = QtWidgets.QPushButton(Window_score_add)
        ...
        self.retranslateUi(Window_score_add)
        QtCore.QMetaObject.connectSlotsByName(Window_score_add)
    ...
    def retranslateUi(self, Window_score_add):
        _translate = QtCore.QCoreApplication.translate

        Window_score_add.setWindowTitle(_translate("Window_score_add", "Form"))
        self.label_title9.setText(_translate("Window_score_add", "学  分："))
        self.label_title6.setText(_translate("Window_score_add", "性  别："))
        self.pushButton_stuno_inquiry.setText(_translate("Window_score_add", "查询"))
        self.label_title7.setText(_translate("Window_score_add", "成  绩："))
        self.pushButton_add.setText(_translate("Window_score_add", "确认添加成绩"))
        self.label_title8.setText(_translate("Window_score_add", "年  龄："))
        self.label_title2.setText(_translate("Window_score_add", "学  号："))
        self.label_title10.setText(_translate("Window_score_add", "班  级："))
        self.label_title4.setText(_translate("Window_score_add", "姓  名："))
        self.label_title1.setText(_translate("Window_score_add", "添加成绩"))
        self.label_title5.setText(_translate("Window_score_add", "课程名："))
        self.label_title3.setText(_translate("Window_score_add", "课程号："))
        self.pushButton_course_inquiry.setText(_translate("Window_score_add", "查询"))
    ...
    def cno_inquiry(self):
        ...
        if not row:
            self.label_coursename.setText("")
            self.label_credit.setText("")
            self.label_course_tip.setText("该学生无此课程成绩！")
            self.label_course_tip.setStyleSheet('color:rgb(255, 0, 0)')
            conn.commit()
            conn.close()
        else:
            self.label_course_tip.setText("该学生该课程成绩为" + str(row[2]) + "分")
    ...
    def add(self):
        ...
        if not row_cjpm:#如果一门成绩也没
            cur.execute("SELECT * FROM xsxx WHERE Sno ='" + sno + "'")
            row_xsxx = cur.fetchone()

            cur.execute("insert into cjpm values('" + sno + "','" + row_xsxx[1] + "','" + row_xsxx[3] + "','" + score + "','" + "0" + "')")
            conn.commit()
            cur.execute("insert into xxxx values('" + sno + "','" + cno + "','" + score + "')")
            conn.commit()
            conn.close()
        elif not row_xxxx:#如果只是这门课没有
            ...
            QtWidgets.QMessageBox.warning(QtWidgets.QWidget(), "警告", "该课已存在成绩",
